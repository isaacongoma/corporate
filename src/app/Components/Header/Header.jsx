...
const Header = ({ isTopBar, variant, logoUrl: logoUrlProp }) => {
  ...
  const menu = {
    email: settings?.contactEmail || 'info@primewatchsecurity.co.ke',
    location: settings?.officeLocation || 'Westlands Business Park, Nairobi',
    logoUrl: logoUrlProp || settings?.logo || '/assets/img/logo.svg',
    logoLink: '/',
    navItems: [
      { label: 'Home', href: '/' },
              ...
              <div className="cs_top_header_in">
                ...
                <div className="cs_top_header_right">
                  <div className="cs_social_btns cs_style_1">
                    <Link href={menu.facebook} className="cs_center"><i><FaFacebookF /></i></Link>
                    <Link href={menu.pinterest} className="cs_center"><i><FaPinterestP /></i></Link>
                    <Link href={menu.twitter} className="cs_center"><i><FaTwitter /></i></Link>
                    <Link href={menu.instagram} className="cs_center"><i><FaInstagram /></i></Link>
                  </div>
                </div>
              </div>
            </div>
