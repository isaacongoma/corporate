    ...
    <>
      <div className="container">
        ...
        <div className="cs_card cs_style_4">
          <div className="cs_card_thumbnail" style={{ position: 'relative', width: 650, height: 719, overflow: 'hidden', flexShrink: 0 }}>
            <Image src={data.mainImage} alt="img" fill style={{ objectFit: 'cover', objectPosition: 'top' }} sizes="650px" />
          </div>
